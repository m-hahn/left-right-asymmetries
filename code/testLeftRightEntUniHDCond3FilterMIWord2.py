...
bad = set(["punct", "reparandum", "parataxis", "orphan", "list", "goeswith", "flat", "fixed", "discourse", "conj", "dep", "dislocated", "det", "compound"])

functional = set(["aux", "case", "cop", "mark"]) # interestingly, these are the ones that are morphologically marked in Japanese


bad = bad.union(functional)
